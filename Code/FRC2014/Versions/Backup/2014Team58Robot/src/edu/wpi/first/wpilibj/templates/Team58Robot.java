...
public class Team58Robot extends IterativeRobot {
    ...
    public void teleopInit() {
        Motors.shotTime.stop();
        Motors.shotTime.reset();
        Motors.shotTime.start();
    }
    ...
    public void teleopPeriodic() {
       ...
       Motors.collectorToggle();
        //Motors.runTrickShot(); //trick shot
     SmartDashboard.putBoolean("Collector Running", Motors.collectorDashboard);
    }
